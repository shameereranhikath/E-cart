...
CREATE TABLE `products` (
  ...
  `prnm` varchar(500) DEFAULT NULL,
  `qty` int DEFAULT NULL,
  `priceperunit` int DEFAULT NULL,
  `description` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`prid`),
  UNIQUE KEY `prnm_UNIQUE` (`prnm`)
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `ProductsTrigger` AFTER INSERT ON `products` FOR EACH ROW begin
...
-- Dump completed on 2022-11-07 17:45:59
