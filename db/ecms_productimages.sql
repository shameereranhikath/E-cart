...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `ProductImagesTrigger` AFTER INSERT ON `productimages` FOR EACH ROW begin
...
-- Dump completed on 2022-11-07 17:45:57
